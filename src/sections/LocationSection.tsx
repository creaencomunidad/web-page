...
const LocationSection: React.FC<LocationSectionProps> = ({ data: { title, locations } }) => {
	return (
		<div
			id="ubicacion"
		...
		>
			<div className="location-title title-font">
				<h2 className="title-font" style={{ lineHeight: '50px' }}>
					{title}
				</h2>
			</div>
					...
					return (
						...
						>
							...
							>
								...
								<span className="text-font location-address-extra">{location.addressExtra}</span>
							</a>
						</div>
					)
				})}
