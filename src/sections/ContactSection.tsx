...
const ContactSection: React.FC<ContactSectionProps> = ({
	...
	return (
		...
		>
			<div
				className="text-font black-text flex w-full flex-row flex-wrap items-center justify-around"
				style={{ maxWidth: '1200px' }}
			>
				<div style={{ maxWidth: '520px', fontSize: '20px', margin: '10px' }}>
					<h2 className="title-font" style={{ color: 'var(--crea-orange)', lineHeight: '50px' }}>
						{title}
					</h2>
					...
					<div className="text-font flex flex-row" style={{ fontSize: '16px' }}>
						<div style={{ padding: '10px 20px 0px  0px', borderRight: '1px solid' }}>
					...
					{socials.map((social, index) => {
						return (
							<div key={'social-' + index} className="mb-3 flex">
								<a
									href={social.href}
				...
				<div className="flex flex-col items-center">
					<div>
						<img src={contactProfile.imgPath} alt={'contact person'} width="350px" />
					</div>
					<div
						style={{
							display: 'flex',
